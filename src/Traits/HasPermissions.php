...
use Lidmo\UserPermission\Exceptions\GuardDoesNotMatch;
use Lidmo\UserPermission\Exceptions\PermissionDoesNotExist;
use Lidmo\UserPermission\Exceptions\WildcardPermissionInvalidArgument;
use Lidmo\UserPermission\Guard;
use Lidmo\UserPermission\PermissionRegistrar;
use Lidmo\UserPermission\WildcardPermission;
...
trait HasPermissions
{
     ...
     * @param  string|int|array|\Lidmo\UserPermission\Contracts\Permission|\Illuminate\Support\Collection  $permissions
     ...
     * Find a permission.
     *
     * @param  string|int|\Lidmo\UserPermission\Contracts\Permission  $permission
    ...
    /**
     * Return all the permissions the model has, both directly and via users.
     */
    ...
    public function givePermissionTo(...$permissions)
    {
        ...
        if (is_a($this, get_class(app(PermissionRegistrar::class)->getUserClass()))) {
     ...
     *
     * @param  \Lidmo\UserPermission\Contracts\Permission|\Lidmo\UserPermission\Contracts\Permission[]|string|string[]  $permission
     * @return $this
     */
    ...
    /**
     * @param  string|int|array|\Lidmo\UserPermission\Contracts\Permission|\Illuminate\Support\Collection  $permissions
     * @return \Lidmo\UserPermission\Contracts\Permission|\Lidmo\UserPermission\Contracts\Permission[]|\Illuminate\Support\Collection
     */
    ...
    /**
     * @param  \Lidmo\UserPermission\Contracts\Permission  $permission
     *
     * @throws \Lidmo\UserPermission\Exceptions\GuardDoesNotMatch
     */
